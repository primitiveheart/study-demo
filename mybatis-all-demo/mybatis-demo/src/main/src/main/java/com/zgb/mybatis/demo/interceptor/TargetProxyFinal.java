 ...
 */
public class TargetProxyFinal implements InvocationHandler {
  private Object target;
  //拦截器
  private InterceptorFinal interceptor;

  private TargetProxyFinal(Object target, InterceptorFinal interceptor) {
    this.target = target;
   ...
   * @return
   */
  public static Object bind(Object target, InterceptorFinal interceptor) {
    return Proxy.newProxyInstance(target.getClass().getClassLoader(),
            target.getClass().getInterfaces(),
            new TargetProxyFinal(target, interceptor));
  }
